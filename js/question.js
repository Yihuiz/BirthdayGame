...
function showWinningMessage() {
    ...
    message.textContent = "Luck Love! You win 2013.14 CHF 🎉";
    message.style.position = 'fixed';
    message.style.top = '50%';
    message.style.left = '50%';
    message.style.transform = 'translate(-50%, -50%)';
    message.style.fontSize = '3rem'; // Large text
    ...
    message.style.padding = '20px 40px'; // Padding for spacing
    ...
    setTimeout(() => {
        ...
        if (answeredQuestions === totalQuestions) {
		 ...
		 showWinningMessage();
           <!-- alert("Luck Love! You win 2013.14 CHF 🎉"); -->
        }
    } else {
